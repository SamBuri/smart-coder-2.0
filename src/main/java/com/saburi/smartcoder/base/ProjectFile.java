...
public abstract class ProjectFile {
    ...
    protected String getFullFileName() {
        String baseFolderName = fileModel.isSaveToProject()?fileModel.getProject().getBaseFolder():fileModel.getOutputFolder();
    ...
    public FileResponse generate() throws Exception {
     this.isValid();
       ...
       return FileResponse.builder()
               ...
               .saveToProject(fileModel.isSaveToProject())
               .openFile(fileModel.isOpenFile())
               .build();
