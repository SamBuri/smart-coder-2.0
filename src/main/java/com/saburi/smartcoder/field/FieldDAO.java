...
//import com.saburi.smartcorder.project.ProjectDAO;
...
//
//        this.variableName = Utilities.getVariableName(this.fieldName);
...
//        return this.field.getReferences();
//    }
//
//
//
...
//                + mapping.get() + ", " + property.get() + ", " + saburiKey.get() + ", "
...
//        return this.getProperty().equalsIgnoreCase(keys.Primary.name());
//    }
//
//    public boolean isPrimaryKeyAuto() {
//        return this.getProperty().equalsIgnoreCase(keys.Primary_Auto.name());
//    }
//
...
//            if (property.get().equalsIgnoreCase("Unique")) {
//
//            }
//
//            if (!nullable.get()) {
...
//        }
//        String column = "";
//        if (property.get().equalsIgnoreCase(keys.Primary.name())) {
//            if (isReferance()) {
...
//                }
//            }
//        } else if (property.get().equalsIgnoreCase(keys.Primary_Auto.name())) {
//            fieldAnnotation += "@Id\n"
...
//                fieldAnnotation += "@NotNull(message =\"The field: " + getCaption() + " cannot be null\")\n";
//            }
//            if (getProperty().equalsIgnoreCase("Unique")) {
//                column += ",unique = false";
//                fieldAnnotation += "@NotNull(message =\"The field: " + getCaption() + " cannot be null\")\n";
//            }
//            column += ")";
...
//        }
//
//        if (getProperty().equalsIgnoreCase(keys.Primary.name())) {
//            if (isReferance()) {
//                fieldAnnotation += "@NotNull(message =  \"The field: " + getCaption() + " cannot be null\")\n";
//
//            } else {
...
//                }
//            }
//        } else if (getProperty().equalsIgnoreCase(keys.Primary_Auto.name())) {
//
//        } else if (isCollection()) {
//            fieldAnnotation += "@Builder.Default";
//
...
//                fieldAnnotation += "@NotNull(message =\"The field: " + getCaption() + " cannot be null\")\n";
//            }
//            if (getProperty().equalsIgnoreCase(keys.Unique.name())) {
//                fieldAnnotation += "@NotNull(message =\"The field: " + getCaption() + " cannot be null\")\n";
//            }
//
//        } else if (dataType.get().equalsIgnoreCase("Image")) {
...
//                            addIfNotExists(list, "import javafx.beans.propertyValue.ObservableValue");
...
//                        + "            final Object propertyValue = event.getNewValue() != null ? event.getNewValue()\n"
//                        + "                    : event.getOldValue();\n"
//                        + "            \n"
//                        + "            ((" + field.getReferencesDA() + ") event.getTableView().getItems()\n"
//                        + "                    .get(event.getTablePosition().getRow()))\n"
//                        + "                    .set" + getFieldName() + "((" + getReferences() + ")propertyValue);\n"
...
//                        + "final " + getDataType() + " propertyValue = event.getNewValue() != null ? event.getNewValue()\n"
//                        + "                    : event.getOldValue();\n"
//                        + getReferences() + " " + variableName + " = o" + getReferencesDA() + ".get" + getReferences() + "(propertyValue);\n"
//                        + "            if (" + variableName + " == null) {\n"
//                        + "                Platform.runLater(() -> {\n"
//                        + "                    message(\"No Item with Id \" + propertyValue + \" found\");\n"
...
//                        + "                    .filter(p -> p.get" + getFieldName() + "ID().equals(propertyValue))\n"
...
//            body += getColumnName(field.getReferences()) + ".setOnEditCommit(event -> {\n"
//                    + "            final String propertyValue = event.getNewValue() != null ? event.getNewValue()\n"
//                    + "                    : event.getOldValue();\n"
//                    + "            ((" + field.getReferencesDA() + ") event.getTableView().getItems()\n"
//                    + "                    .get(event.getTablePosition().getRow()))\n"
//                    + "                    .set" + getFieldName() + "(defortFloat(propertyValue));\n"
//                    + "            " + field.getControlName() + ".refresh();\n"
//                    + "            addRowOnce(" + field.getControlName() + ",new " + field.getReferencesDA() + "());\n"
//                    + "        });";
//        } else if (type.equalsIgnoreCase("double")) {
...
//                    + "            ((" + field.getReferencesDA() + ") event.getTableView().getItems()\n"
//                    + "                    .get(event.getTablePosition().getRow()))\n"
//                    + "                    .set" + getFieldName() + "(defortNumberOptional(propertyValue));\n"
//                    + "            " + field.getControlName() + ".refresh();\n"
//                    + "            addRowOnce(" + field.getControlName() + ",new " + field.getReferencesDA() + "());\n"
//                    + "        });";
//        } else if (type.equalsIgnoreCase("int") || type.equalsIgnoreCase("Integer")) {
...
//                    + "            ((" + field.getReferencesDA() + ") event.getTableView().getItems()\n"
//                    + "                    .get(event.getTablePosition().getRow()))\n"
//                    + "                    .set" + getFieldName() + "(getInt(propertyValue));\n"
//                    + "            " + field.getControlName() + ".refresh();\n"
//                    + "            addRowOnce(" + field.getControlName() + ",new " + field.getReferencesDA() + "());\n"
//                    + "        });";
//        } else {
...
//                    + "            ((" + field.getReferencesDA() + ") event.getTableView().getItems()\n"
//                    + "                    .get(event.getTablePosition().getRow()))\n"
//                    + "                    .set" + getFieldName() + "(propertyValue);\n"
//                    + "            " + field.getControlName() + ".refresh();\n"
//                    + "            addRowOnce(" + field.getControlName() + ",new " + field.getReferencesDA() + "());\n"
//                    + "        });";
//        }
...
//    }
//
//    public String setControlText(String propertyValue) {
//        if (isHelper()) {
//            return "";
//        }
//        switch (getControlType()) {
//            case ComboBox -> {
//                return getControlName() + ".setPropertyValue(" + propertyValue + ");\n";
//            }
//            case DatePicker -> {
//                return getControlName() + ".setPropertyValue((" + getDataType() + ")" + propertyValue + ");\n";
//            }
//            case CheckBox -> {
//                return getControlName() + ".setSelected(" + propertyValue + ");\n";
//            }
//            case ImageView -> {
//                return "setImage(" + getControlName() + ", " + propertyValue + ");\n";
//            }
//            default -> {
//                if (getDataType().equalsIgnoreCase("int") || getDataType().equalsIgnoreCase("Integer")) {
//                    return getControlName() + ".setText(String.valueOf(" + propertyValue + "));\n";
//                } else if (getDataType().equalsIgnoreCase("float") || getDataType().equalsIgnoreCase("double")) {
//                    return getControlName() + ".setText(formatNumber(" + propertyValue + "));\n";
//                } else {
//                    return getControlName() + ".setText(" + propertyValue + ");\n";
//                }
//            }
//        }
//    }
