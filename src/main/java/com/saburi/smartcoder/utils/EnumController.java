package com.saburi.smartcoder.utils;
...
public class EnumController {
    ...
    @GetMapping("javaprojecttypes")
    public Enums.JavaProjectTypes [] getJavaProjectTypes(){
        return Enums.JavaProjectTypes.values();
    }

    @GetMapping("javascriptprojecttypes")
    public Enums.JavaScriptProjectTypes [] getJavaScriptProjectTypes(){
        return Enums.JavaScriptProjectTypes.values();
    }
    ...
    public Enums.Languages[] getLanguages(){
        return Enums.Languages.values();
    }
