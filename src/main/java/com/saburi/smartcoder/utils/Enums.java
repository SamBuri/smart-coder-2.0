...
public class Enums {
    ...
    public static enum UIControls {
        ...
        MultiSelectCombo, ImageView, TableView, FileBrowser, SNumberInput, MultiSelectField, SelectField
    }
    ...
    public enum Languages{Java, JavaScript}

    public enum ProjectTypes {
        Springboot, Vue, Vue3, JavaFX
    };

    public enum JavaProjectTypes {
        Springboot, JavaFX
    };

    public enum JavaScriptProjectTypes {
         Vue
    };
    ...
    public enum VueFiles {
        All, Model, View, Store, Nav,Search, Controller
    };
